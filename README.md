...
### Setup Database
+ Pull and run database in docker
```
...
```
+ Connect to sql server and run database scripts (connecting to 'localhost' from azure data studio works well)
1. CreateDatabase.sql
2. CreateTables.sql
3. Team.PostDeployment.sql
### Run Data Collection
+ Build
```
dotnet build
